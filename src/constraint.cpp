...
std::string Constraint::DescriptionString() const {
    std::string s;
    switch(type) {
        case Type::POINTS_COINCIDENT:   s = C_("constr-name", _("pts-coincident")); break;
        case Type::PT_PT_DISTANCE:      s = C_("constr-name", _("pt-pt-distance")); break;
        case Type::PT_LINE_DISTANCE:    s = C_("constr-name", _("pt-line-distance")); break;
        case Type::PT_PLANE_DISTANCE:   s = C_("constr-name", _("pt-plane-distance")); break;
        case Type::PT_FACE_DISTANCE:    s = C_("constr-name", _("pt-face-distance")); break;
        case Type::PROJ_PT_DISTANCE:    s = C_("constr-name", _("proj-pt-pt-distance")); break;
        case Type::PT_IN_PLANE:         s = C_("constr-name", _("pt-in-plane")); break;
        case Type::PT_ON_LINE:          s = C_("constr-name", _("pt-on-line")); break;
        case Type::PT_ON_FACE:          s = C_("constr-name", _("pt-on-face")); break;
        case Type::EQUAL_LENGTH_LINES:  s = C_("constr-name", _("eq-length")); break;
        case Type::EQ_LEN_PT_LINE_D:    s = C_("constr-name", _("eq-length-and-pt-ln-dist")); break;
        case Type::EQ_PT_LN_DISTANCES:  s = C_("constr-name", _("eq-pt-line-distances")); break;
        case Type::LENGTH_RATIO:        s = C_("constr-name", _("length-ratio")); break;
        case Type::LENGTH_DIFFERENCE:   s = C_("constr-name", _("length-difference")); break;
        case Type::SYMMETRIC:           s = C_("constr-name", _("symmetric")); break;
        case Type::SYMMETRIC_HORIZ:     s = C_("constr-name", _("symmetric-h")); break;
        case Type::SYMMETRIC_VERT:      s = C_("constr-name", _("symmetric-v")); break;
        case Type::SYMMETRIC_LINE:      s = C_("constr-name", _("symmetric-line")); break;
        case Type::AT_MIDPOINT:         s = C_("constr-name", _("at-midpoint")); break;
        case Type::HORIZONTAL:          s = C_("constr-name", _("horizontal")); break;
        case Type::VERTICAL:            s = C_("constr-name", _("vertical")); break;
        case Type::DIAMETER:            s = C_("constr-name", _("diameter")); break;
        case Type::PT_ON_CIRCLE:        s = C_("constr-name", _("pt-on-circle")); break;
        case Type::SAME_ORIENTATION:    s = C_("constr-name", _("same-orientation")); break;
        case Type::ANGLE:               s = C_("constr-name", _("angle")); break;
        case Type::PARALLEL:            s = C_("constr-name", _("parallel")); break;
        case Type::ARC_LINE_TANGENT:    s = C_("constr-name", _("arc-line-tangent")); break;
        case Type::CUBIC_LINE_TANGENT:  s = C_("constr-name", _("cubic-line-tangent")); break;
        case Type::CURVE_CURVE_TANGENT: s = C_("constr-name", _("curve-curve-tangent")); break;
        case Type::PERPENDICULAR:       s = C_("constr-name", _("perpendicular")); break;
        case Type::EQUAL_RADIUS:        s = C_("constr-name", _("eq-radius")); break;
        case Type::EQUAL_ANGLE:         s = C_("constr-name", _("eq-angle")); break;
        case Type::EQUAL_LINE_ARC_LEN:  s = C_("constr-name", _("eq-line-len-arc-len")); break;
        case Type::WHERE_DRAGGED:       s = C_("constr-name", _("lock-where-dragged")); break;
        case Type::COMMENT:             s = C_("constr-name", _("comment")); break;
        default:                        s = "???"; break;
    }
